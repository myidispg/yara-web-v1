...
export default function ShopAllPage() {
    ...
    const activeCount = (selectedCategory ? 1 : 0) + sel.karat.length + sel.color.length + (inStockOnly ? 1 : 0) + (sel.priceMax < 200000 ? 1 : 0);
        ...
        <div className="bg-white pb-28 lg:pb-12">
            <div className="max-w-[1920px] mx-auto px-2 sm:px-4 lg:px-6 pt-8 pb-12 space-y-8">
                ...
                <p className="text-xs text-gray-500">
                    <Link href="/" className="hover:text-[#B86B5A]">Home</Link> / Shop All
                </p>
