                        ...
                        <div className="glass-card-vibrant rounded-2xl border border-[#E5BDB0] p-5">
                            <div className="flex items-start gap-3 mb-3">
                                <div className="w-10 h-10 rounded-full bg-[#1A2536] flex items-center justify-center flex-shrink-0">
                                    <svg className="w-5 h-5 text-[#E5BDB0]" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2">
                                        ...
                                        <path strokeLinecap="round" strokeLinejoin="round" d="M15 11a3 3 0 1 0-6 0 3 3 0 0 1-6 0z" />
                                    </svg>
                                </div>
                                    ...
                                    {pincodeResult.error ? (
                                        ...
                                        <div className="flex items-start gap-3 p-3 rounded-xl bg-[#B86B5A]/10 border border-[#B86B5A]/30">
                                            <div className="w-8 h-8 rounded-full bg-[#B86B5A]/20 flex items-center justify-center flex-shrink-0">
                                                <svg className="w-4 h-4 text-[#B86B5A]" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2">
                                                    <path strokeLinecap="round" strokeLinejoin="round" d="M18.364 18.364A9 9 0 0 0 5.636 5.636m12.728 12.728A9 9 0 0 1 5.636 5.636m12.728 12.728L5.636 5.636" />
                                                    <path strokeLinecap="round" strokeLinejoin="round" d="M15 11a3 3 0 1 0-6 0 3 3 0 0 1 0-6 0z" />
                                                </svg>
                                            </div>
                                            <div className="flex-1">
                                            ...
                                            <div className="flex items-center gap-2 pl-11">
                                                <div className={`w-6 h-6 rounded-full flex items-center justify-center ${pincodeResult.codAvailable ? "bg-emerald-50" : "bg-[#1A2536]/5"}`}>
                                                    {pincodeResult.codAvailable ? (
                                                        ...
                                                        <svg className="w-3.5 h-3.5 text-[#1A2536]/40" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2.5">
