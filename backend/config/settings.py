...
REST_FRAMEWORK = {
    "DEFAULT_AUTHENTICATION_CLASSES": (
        "accounts.authentication.CookieJWTAuthentication",  # Changed from JWTAuthentication
    ),
...
SIMPLE_JWT = {
    ...
    "ROTATE_REFRESH_TOKENS": False,  # We handle rotation in CookieTokenRefreshView
